...
def faceDetect():
    ...
    imgbackground = cv2.imread('engine/auth/gui_content/background.jpg')

    # importing the mode images
    folderModePath = 'engine/auth/gui_content/Modes'
    ...
    with open('engine/auth/Encoding.p', 'rb') as file:
